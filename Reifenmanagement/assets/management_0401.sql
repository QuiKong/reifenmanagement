...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 03. Jan 2022 um 19:15
...
CREATE TABLE `reifen2` (
  ...
  `Reifensatz` int(11) NOT NULL,
  `Art` int(11) NOT NULL,
  `Spezifikation` int(11) NOT NULL,
  `Position` int(11) NOT NULL,
  `Kaltdruck` int(11) NOT NULL,
  `TempAbholung` int(11) NOT NULL,
  `Zieldruck` int(11) NOT NULL,
  `Zieltemperatur` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `rennwochenende` (`WeID`, `Von_Datum`, `Bis_Datum`, `Strecke`, `Format`, `Bemerkung`) VALUES
(1, '2022-01-06', '2022-01-09', 'Belgien-Spa', 'VLN', 'Starker Regen vorhergesagt');
...
--
ALTER TABLE `reifensatz`
  MODIFY `Reifensatz` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `rennwochenende`
--
ALTER TABLE `rennwochenende`
  MODIFY `WeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `sprit`
  MODIFY `VorgangsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `wetter`
  MODIFY `MessID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `bestellung`
  ADD CONSTRAINT `bestellung_ibfk_1` FOREIGN KEY (`Status`) REFERENCES `status` (`StatusID`),
...
--
-- Constraints der Tabelle `reifensatz`
--
ALTER TABLE `reifensatz`
  ADD CONSTRAINT `reifensatz_ibfk_1` FOREIGN KEY (`Bestellung`) REFERENCES `bestellung` (`BestellNr`);
